    ...
    grid.innerHTML = ITEMS.slice(0, 10).map(it => `
      <div class="card">
        ...
        <div style="display:flex;justify-content:space-between;align-items:center;margin-top:8px">
          ...
          <div class="price">${formatUSD(priceForCategory(it.category))}</div>
        </div>
      </div>
    `).join('');
    return;
...
const ITEMS = [
  { name: "Gaming Laptop 15\"", category: "laptop", image: "/ORGWEB/images/laptop.png" },
  { name: "Wireless Headphones", category: "headphones", image: "" },
  { name: "Mechanical Keyboard", category: "keyboard", image: "" },
  { name: "Ergonomic Office Chair", category: "chair", image: "" },
  { name: "Running Shoes", category: "shoes", image: "" },
  { name: "Ceramic Coffee Mug", category: "mug", image: "" },
  { name: "Paperback Novel", category: "book", image: "" },
  { name: "Smartphone", category: "phone", image: "" },
  { name: "27\" Monitor", category: "monitor", image: "" },
  { name: "Backpack", category: "backpack", image: "" },
  { name: "Bluetooth Speaker", category: "speaker", image: "" },
  { name: "Desk Lamp", category: "desk lamp", image: "" },
  { name: "Skateboard", category: "skateboard", image: "" },
  { name: "Digital Camera", category: "camera", image: "" },
  { name: "Hoodie", category: "hoodie", image: "" },
  { name: "Wrist Watch", category: "watch", image: "" },
  { name: "Wireless Mouse", category: "mouse", image: "" },
  { name: "Video Game", category: "video game", image: "" },
  { name: "LEGO Set", category: "lego set", image: "" },
  { name: "Bicycle", category: "bicycle", image: "" }
];
...
function initTenItemGrid() {
  const btn = document.getElementById("searchBtn");     // use your existing button
  const input = document.getElementById("searchInput"); // use your existing input
  ...
  searchAndShowTen(""); // show 10 on load
}
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const homePage = document.getElementById("homePage"); // if you have one
  const btn = document.getElementById("searchBtn");
  const input = document.getElementById("searchInput");

  // ensure correct default view
