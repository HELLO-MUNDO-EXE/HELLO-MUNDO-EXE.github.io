...
const ITEMS = [
  ...
  { name: "Backpack", category: "backpack", image: "images/backpack.jpg" },
  { name: "Bluetooth Speaker", category: "speaker", image: "images/speaker.jpg" },
  { name: "Desk Lamp", category: "desk lamp", image: "images/desk-lamp.jpg" },
...
}
{
  ...
  searchAndShowTen(searchInput.value.trim());
  });
